...
namespace SteamAPIWrap
{
	...
	Enum CGameServer::BeginAuthSession( PConstantDataPointer authTicket, int authTicketSize, SteamID steamID )
	{
...
ManagedSteam_API bool GameServer_BLoggedOn()
{
	return CGameServer::Instance().BLoggedOn();
}

ManagedSteam_API bool GameServer_BSecure()
{
...
ManagedSteam_API Enum GameServer_BeginAuthSession( PConstantDataPointer authTicket, int authTicketSize, SteamID steamID )
{
