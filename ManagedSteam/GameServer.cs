...
namespace ManagedSteam
{
    ...
    public interface IGameServer
    {
        ...
        /// <returns></returns>
        AuthTicketHandle GetAuthSessionTicket(byte[] ticket, out uint ticketSize);

        GameServerGetAuthSessionTicketResult GetAuthSessionTicket(byte[] ticket);
        ...
        /// <returns></returns>
        BeginAuthSessionResult BeginAuthSession(byte[] authTicket, SteamID steamID);
