...
namespace ManagedSteam
{
    ...
    public sealed class Steam
    {
        ...
        [Obsolete("Do not use. Will be removed. Use the Constants class instead.")]
        ...
        private void RegisterManagedCallback()
        {
            ...
            NativeMethods.Services_RegisterManagedCallbacks(NativeCallbacks, NativeResultCallbacks);
        }
