...
namespace ManagedSteam.Implementations
{
    class User : SteamService, IUser
    {
        ...
        public uint GetAuthSessionTicket(System.IntPtr ticket, int maxTicket, out uint ticketLength)
        {
            CheckIfUsable();
            ticketLength = 0;
            return NativeMethods.User_GetAuthSessionTicket(ticket, maxTicket, ref ticketLength);
        }
