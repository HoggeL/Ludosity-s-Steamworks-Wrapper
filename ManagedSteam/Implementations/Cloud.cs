...
namespace ManagedSteam.Implementations
{
    class Cloud : SteamService, ICloud
    {
        ...
        /// 
        /// </summary>
        public bool GetUGCDetails(SteamTypes.UGCHandle handle, out SteamTypes.AppID appID, out string name,
            out int fileSize, out SteamTypes.SteamID creator)
        {
            CheckIfUsable();
        ...
        public int UGCRead(SteamTypes.UGCHandle handle, byte[] data, uint offset)
        {
            CheckIfUsable();
        ...
        public void GetPublishedFileDetails(PublishedFileId publishedFileId)
        {
            CheckIfUsable();
            NativeMethods.Cloud_GetPublishedFileDetails(publishedFileId.AsUInt64);
        }
