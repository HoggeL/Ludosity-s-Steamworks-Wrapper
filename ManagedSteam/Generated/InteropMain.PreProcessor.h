...
// Defined: RemoteStorage_h_interop_ -> 
 ...
 s32 Cloud_UGCRead(UGCHandle handle, PDataPointer buffer, s32 bufferLength, u32 offset);
 ...
 void Cloud_GetPublishedFileDetails(PublishedFileId publishedFileId);
