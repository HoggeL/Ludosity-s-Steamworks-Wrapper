...
namespace ManagedSteam.CallbackStructures
{
    ...
    /// </summary>
	//HARDCODED SIZE
    [StructLayout(LayoutKind.Sequential, Pack = NativeHelpers.SteamStructPacking, Size=24)]
    public struct UserStatsReceived // UserStatsReceived_t
    {
        ...
        public SteamTypes.AppID GameID { get { return new SteamTypes.AppID(gameID); } }
    ...
    /// </summary>
	//HARDCODED SIZE
    [StructLayout(LayoutKind.Sequential, Pack = NativeHelpers.SteamStructPacking, Size=16)]
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = NativeHelpers.SteamStructPacking, CharSet = CharSet.Ansi, Size = 152)]
